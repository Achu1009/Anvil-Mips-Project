...
| | SV baseline | port1_serialised_legacy | this directory |
|---|---|---|---|
| cycles / instruction | 1 | 11 | **1** |
| stages overlapped | 5 | 1 | **5** |
| handshake wires in RTL | n/a | 464 | **0** |
| generated RTL lines | n/a | 2625 | **967** |
| forwarding unit | yes | none | **yes** |
| load-use stall | yes | none | **yes** |
| $zero violations | 0 | 1 | **0** |
